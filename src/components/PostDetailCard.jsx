const PostDetailCard = ({ post }) => {
  ...
  return (
    <div className="grid grid-cols-2 gap-4 justify-center border-[1px] rounded-md p-4">
      <div className="w-[400px]">
        ...
        <div className="border-[1px] rounded-md p-2 mb-4 mt-2">{post.title}</div>
        <span className="m-2 font-bold">내용</span>
        <div className="border-[1px] rounded-md p-2 mb-2 mt-2 h-[200px]">{post.postContent}</div>
        <div className="p-2">
