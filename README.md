...
<img src="https://github.com/user-attachments/assets/aa04aa95-4c18-4d01-98f2-3bcdbac04c30" alt="무한스크롤 시연 움짤"/>
</br>
⬆️무한스크롤

- 사용자는 스크롤을 아래로 내려서 '끝이에요' 글자를 보는 것으로 다음 포스트 데이터를 불러올 수 있습니다.(json-server 버젼 이슈로 프로젝트에 반영되지 못한 기능)
